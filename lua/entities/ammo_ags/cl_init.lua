...
local function Draw3DText( pos, ang, scale, text, flipView )
	...
	cam.Start3D2D( pos, ang, scale )
		...
		--draw.DrawText( text, "N40_DisplayFont42", 0, 0, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER )
	cam.End3D2D()
end
